...
function buscarObraVisble(str) {

  // Si no se escribe nada no se muestra nada de resultado.
  if (str == "") {
      document.getElementById("muestra_obras_visible").innerHTML = "";
      return;
  } 
  else {
      ...
      xmlhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) {
              document.getElementById("muestra_obras_visible").innerHTML = this.responseText;
          }
      };
      // Se envia con GET la cadena a buscar en la BD
      xmlhttp.open("GET","modules/buscarobravisible.php?q=" + str, true);
      // Se muestra
      xmlhttp.send();
  }
}
